...
extern"C"
{
    ...
    JNIEXPORT void JNICALL Java_edu_nyp_deafapp_FaceRecognitionActivity_initLoad(JNIEnv* env, jobject, jstring haarfilePath)
    {
    ...
    JNIEXPORT void JNICALL Java_edu_nyp_deafapp_FaceRecognitionActivity_faceDetect(JNIEnv* env, jobject, jlong addrRgba)
    {
